...
class SiglipAttention(nn.Module):
    ...
    def forward(self, hidden_states: torch.Tensor) -> Tuple[torch.Tensor, Optional[torch.Tensor]]:
        ...
        # key_states: (Batch_Size, Num_Pathces, Embed_Dim)
        ...
        # Q * K^T / sqrt(d_k). attn_weights: (Batch_Size, Num_Heads, Num_Patches, Num_Patches)
        ...
        # Multiply attn_weights with value states: (Batch_Size, Num_Heads, Num_Patches, Head_Dim)
